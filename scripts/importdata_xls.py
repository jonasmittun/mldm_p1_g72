...
doc = xlrd.open_workbook('../data/Dry_Bean_Dataset.xls').sheet_by_index(0)

# Extract attribute names
attributeNames = doc.row_values(rowx=0, start_colx=0, end_colx=17)
...
# and up to 151:
classLabels = doc.col_values(16,1,13612) # check out help(doc.col_values)
...
X = np.empty((13611,16))
for i in range(16):
    X[:,i] = np.array(doc.col_values(i,1,13612)).T
